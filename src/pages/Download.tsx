...
const downloadLinks = [
  {
    ...
    url: "https://github.com/cavalinho-xdd/aurora/releases/download/v1.0.10-alpha.2/Aurora-Setup-1.0.10-alpha.2.exe"
  },
  {
    os: "macOS",
    arch: "Arm64",
    ...
    url: "https://github.com/cavalinho-xdd/aurora/releases/download/v1.0.10-alpha.2/Aurora-1.0.10-alpha.2-arm64.dmg"
  },
  {
    os: "Linux",
    arch: "Universal",
    ...
    url: "https://github.com/cavalinho-xdd/aurora/releases/download/v1.0.10-alpha.2/Aurora-1.0.10-alpha.2.AppImage"
  },
  {
    os: "Linux",
    arch: "Debian/Ubuntu",
    ...
    Icon: LinuxIcon,
    iconColor: "text-yellow-500",
    url: "https://github.com/cavalinho-xdd/aurora/releases/download/v1.0.10-alpha.2/aurora_1.0.10-alpha.2_amd64.deb"
  }
];
